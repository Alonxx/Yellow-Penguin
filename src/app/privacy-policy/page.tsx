      ...
      <div className="flex flex-col justify-center items-center pt-10 pb-20">
        ...
        <div className="w-[70%]">
          ...
          <h2 className="text-2xl mb-2">
            Yellow Penguin makes ad-supported apps
          </h2>
          <p>
            This SERVICE is provided by Yellow Penguin at no cost and is
            ...
            are accessible at our apps unless otherwise defined in this Privacy
            Policy.
          </p>
